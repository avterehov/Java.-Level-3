...
public class Main {
    ...
    public static void  main (String [] args){
        ...
        int [] sourseArray = new int[] {5, 1, 5, 2, 2, 4, 1, 4, 5, 1, 5, 3, 2, 4, 4, 4, 5, 1, 3, 4, 2, 2, 1, 2, 4, 4, 4, 5, 4, 3, 5, 4, 4, 5, 5, 1, 4, 1, 5, 3, 1, 4, 5, 3, 3, 4, 2, 2, 4, 4, 5, 5, 1, 1, 1, 4, 5, 5,
        ...
        //  в условии задачи было, массиве могут быть числа от 1 до 20 поэтому оставил счетчик до 20,
        //  хотя во входном массиве значение элементов массива не превышает 5
        int [] counterArray = new int [21];

        for ( int i = 0; i < sourseArray.length; i ++ ){
                        counterArray[sourseArray[i]] ++;
